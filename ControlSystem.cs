...
using Daniels.PrincipalHall.Lighting;

namespace JsonTest
{
    public class ControlSystem : CrestronControlSystem
    {
        public enum eIpId : uint
        {
            CenCi3 = 0x05,
            ...
            // Multiwindows/Streaming resource 1
            //STR1_NVX_RX = 0x13,
            STR1_WP = 0x14,
            STR1_DGE = 0x15,
            STR1_TXRX = 0x16,

            // Streaming resource 2
            //STR2_NVX_RX = 0x19,
            STR2_TX = 0x1A,
            STR2_DGE = 0x1B,
            STR2_TXRX = 0x1C,

            // Streaming resource 3
            //STR3_NVX_RX = 0x1E,
            STR3_TX = 0x1F,
            STR3_DGE = 0x20,
            STR3_TXRX = 0x21,
        ...
        private readonly string eiscDescription = "EISC to suplemental program";
        private readonly string eiscIP = "127.0.0.2";

        // Define local variables ...
        public XpanelForSmartGraphics uiAdminWeb;
        private readonly string uiAdminWebDescription = "Crestron Admin UI";
        private readonly string uiAdminWebSGD = "DanielsLightingExample.sgd";

        LightsControl lightsControl;
        LightsControlUI lightsControlUI;
            ...
            : base()
        {
            try
            {
                ...
                lightsControlUI = new LightsControlUI(new List<BasicTriListWithSmartObject>() { uiAdminWeb});
        ...
        public override void InitializeSystem()
        {
            try
            {
                lightsControl = LightsControl.GetInstance(eisc);
                lightsControl.Initialize();
                lightsControlUI.Initialize();
